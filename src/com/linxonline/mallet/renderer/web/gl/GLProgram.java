...
public class GLProgram extends Resource
{
	...
	*/
	...
	public WebGLUniformLocation inMVPMatrix = null ;		// Additional uniforms defined in *.jgl and shaders
	public final WebGLUniformLocation[] inUniforms ;		// Vertex swivel order defined in *.jgl
