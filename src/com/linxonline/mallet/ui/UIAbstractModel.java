...
*/
public interface UIAbstractModel
{
	...
	*/
	public void setData( final UIModelIndex _index, final UIVariant _variant, final Role _role ) ;

	/**
		Return the value stored at _index location based on the _role.
	*/
	public UIVariant getData( final UIModelIndex _index, final Role _role ) ;
